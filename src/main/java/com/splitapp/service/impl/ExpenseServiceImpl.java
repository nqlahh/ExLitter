...
public class ExpenseServiceImpl implements ExpenseService {
    ...
    public Expense addExpense(Long groupId, String description, BigDecimal amount,
        ...
        List<Member> participants;
            ...
            // Explicitly handle cases where a user clears selections intentionally
        if (participantIds == null || participantIds.isEmpty()) {
            // Option 1: Prevent a broken 0-person split by throwing an error back to the UI
            throw new IllegalArgumentException("An expense must have at least one participant shared in the split.");
        } else {
